...
public enum SafeSounds {
    THUNDER("AMBIENCE_LIGHTNING_THUNDER", "ENTITY_LIGHTNING_BOLT_THUNDER"),
    WITHER_SPAWN("WITHER_SPAWN", "ENTITY_WITHER_SPAWN"),
    LAVA_POP("LAVA_POP", "BLOCK_LAVA_POP"),
    CLICK("CLICK", "UI_BUTTON_CLICK"),
    ENDERMAN_TELEPORT("ENTITY_ENDERMEN_TELEPORT", "ENTITY_ENDERMAN_TELEPORT"),
    IRONGOLEM_DEATH("ENTITY_IRONGOLEM_DEATH", "ENTITY_IRON_GOLEM_DEATH");
