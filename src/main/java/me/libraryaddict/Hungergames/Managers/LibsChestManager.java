...
public class LibsChestManager implements ChestManager {
    ...
    public LibsChestManager() {
        ...
        randomItems.add(new RandomItem(20, Material.MUSHROOM_STEW, 0, 1, 7));
        ...
        randomItems.add(new RandomItem(20, Material.COBWEB, 0, 1, 2));
        ...
        randomItems.add(new RandomItem(20, Material.COOKED_PORKCHOP, 0, 1, 20));
        ...
        randomItems.add(new RandomItem(20, Material.EXPERIENCE_BOTTLE, 0, 1, 10));
